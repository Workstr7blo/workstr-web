...
- `src/features/monero/tip-jar-state.ts` is the single answer to "what state is the Tip
  ...
  in the Settings wallet card's diagnostics. The page is balance, Receive, Send and Recent
  activity; whether tips reach this wallet and the backup live in Settings (#263).
