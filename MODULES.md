...
| Monero wallet phase-1 spike and phase-2 wallet core (#246): runtime import, node reachability, lazy wallet runtime, vault storage, mock stagenet wallet, and QA evidence | `src/features/monero/wallet-node.ts`, `src/features/monero/wallet-runtime.ts`, `src/features/monero/wallet-core.ts`, `src/features/monero/wallet-storage.ts`, `src/features/monero/wallet-spike.ts`, `src/features/monero/mock-stagenet-wallet.ts`, `src/features/monero/phase1-report.ts`, `src/features/monero/types.ts` | `src/monero-spike.ts`, `monero-spike.html`, `vite.monero-spike.config.ts`, `scripts/monero-spike-browser.mjs`, `docs/monero-wallet-phase1.md`, `docs/monero-wallet-phase2-core.md`, `docs/monero-ios-qa-checklist.md`, `docs/monero-rpc-browser-bridge.md`, `src/security/device-vault.ts` | `tests/monero-wallet-spike.test.ts`, `tests/monero-wallet-core.test.ts`, `npm run spike:monero:browser` |
